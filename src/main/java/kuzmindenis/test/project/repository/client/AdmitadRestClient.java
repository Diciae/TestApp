package kuzmindenis.test.project.repository.client;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.node.ObjectNode;
import kuzmindenis.test.project.dto.AccessTokenResponse;
...
public class AdmitadRestClient {
    ...
    public JsonNode getPrograms(String accessToken, int limit) {
        HttpHeaders httpHeaders = new HttpHeaders();
        ...
        ResponseEntity<ObjectNode> response = restTemplate.exchange(
                "https://api.admitad.com/advcampaigns/website/2090016/?limit=" + limit,
                HttpMethod.GET,
                httpEntity,
                ObjectNode.class
        );
        ...
        if (!response.hasBody() || response.getStatusCode() != HttpStatus.OK) {
            throw new RuntimeException("Couldn't get programs");
        }
